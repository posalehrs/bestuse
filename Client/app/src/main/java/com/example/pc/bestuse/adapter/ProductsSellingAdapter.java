...
public class ProductsSellingAdapter extends RecyclerView.Adapter<ProductsSellingAdapter.MyViewHolder> {

    private List<Product> productsList;
    private Context mContext;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView name, description,old_price,new_price,expiration_date,up_date,amount;
        ...
        public MyViewHolder(View view) {
            ...
            expiration_date=(TextView)view.findViewById(R.id.product_expiration_date);
            up_date=(TextView)view.findViewById(R.id.product_update_date);
            logo = (ImageView) view.findViewById(R.id.product_image);
        }
    }


    public ProductsSellingAdapter(List<Product> productsList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_row_selling, parent, false);
