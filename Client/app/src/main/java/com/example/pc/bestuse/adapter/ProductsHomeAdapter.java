...
public class ProductsHomeAdapter extends RecyclerView.Adapter<ProductsHomeAdapter.MyViewHolder> {
    ...
    public ProductsHomeAdapter(List<Product> productsList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_row_home, parent, false);
